Feature: Compare interventions basic concrete
  Background:
    ...
    | average_age     | float | 29.743430714827714 |
    | quar_period     | int   | 0                  |
  ...
  Scenario: average_age -- @1.1 
    Given we run the model with average_age=29.743430714827714
    When we run the model with average_age=38.15674090285034
  ...
  Scenario: probs -- @1.1 
    ...
    And pop_size=1001
    And pop_infected=1
    And average_age=38.15674090285034
    And quar_period=1
    Then the cum_tests should increase
